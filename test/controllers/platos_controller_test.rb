...
class PlatosControllerTest < ActionController::TestCase
  ...
  test "should create plato" do
    assert_difference('Plato.count') do
      post :create, plato: { cantidad: @plato.cantidad, descripcion: @plato.descripcion, nombre: @plato.nombre, precio: @plato.precio }
    end
  ...
  test "should update plato" do
    patch :update, id: @plato, plato: { cantidad: @plato.cantidad, descripcion: @plato.descripcion, nombre: @plato.nombre, precio: @plato.precio }
    assert_redirected_to plato_path(assigns(:plato))
  end
