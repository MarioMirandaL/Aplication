...
class ComprasControllerTest < ActionController::TestCase
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post :create, compra: { distribuidor_id: @compra.distribuidor_id, fecha_compra: @compra.fecha_compra, fecha_entrega: @compra.fecha_entrega, producto_id: @compra.producto_id }
    end
  ...
  test "should update compra" do
    patch :update, id: @compra, compra: { distribuidor_id: @compra.distribuidor_id, fecha_compra: @compra.fecha_compra, fecha_entrega: @compra.fecha_entrega, producto_id: @compra.producto_id }
    assert_redirected_to compra_path(assigns(:compra))
  end
